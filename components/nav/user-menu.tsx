  ...
  return (
    ...
    >
      ...
      <Link
        href="/criar-conta"
        onClick={onClose}
        className="mb-6 flex w-full items-center justify-center gap-2 rounded-xl bg-brand px-4 py-3 text-[13px] font-semibold text-brand-foreground transition-opacity hover:opacity-90"
      >
